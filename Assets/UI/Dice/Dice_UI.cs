...
public class Dice_UI : MonoBehaviour
{
    ...
    [SerializeField] private GameObject diceExteranalObject;
    ...
    {
        if (diceExteranalObject == null) return;
    ...
    {
        if (!isFading || labelCanvasGroup == null) return;
    ...
    private void StartDiceRollPlaceholder()
    {
        ...
        Invoke(nameof(OnDiceRollComplete), 2f);
    }
